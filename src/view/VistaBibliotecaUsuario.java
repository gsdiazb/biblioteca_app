...
public class VistaBibliotecaUsuario extends JDialog {
	...
	public VistaBibliotecaUsuario() {
		...
		lblLogo.setIcon(new ImageIcon("logo-libreria.png"));
//		lblLogo.setBounds(30,100,200,400);
		...
		dialog.setTitle("Inicio de Sesionnnn");
